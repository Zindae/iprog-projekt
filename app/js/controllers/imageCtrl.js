myApp.controller('imageCtrl', function($scope, $http, $q) {
	...
	vm.loadMoreShots = function() {
		...
		var promise = $http.get('https://api.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=38c248a92d1a579098352a361c8871e2&per_page=24&page='+vm.page+'&format=json&nojsoncallback=1');
		// console.log(promise);
